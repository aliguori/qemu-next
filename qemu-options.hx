...
DEF("net", HAS_ARG, QEMU_OPTION_net,
...
#else
    "-net tap[,vlan=n][,name=str][,fd=h][,ifname=name][,script=file][,downscript=dfile][,sndbuf=nbytes][,vnet_hdr=on|off][,helper=program]\n"
    ...
    "                use helper to specify the name of a program to launch to allocate the tap device\n"
#endif
