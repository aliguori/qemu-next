...
{
    ram_addr_t page = qemu_ram_alloc(PAGESIZE);
    memset(qemu_get_ram_ptr(page), 0xff, PAGESIZE);
    return page;
}

static void msx_mmu_load_rom(void *opaque, int addr, int slot,
                                   ...
                                   const char *filename)
{
    ...
    switch (rom_size / PAGESIZE) {
        case 0 ... 1:
            page[0] = msx_mmu_alloc_page() | IO_MEM_ROM;
            page[1] = page[0];
            page[2] = page[0];
            page[3] = page[0];
            page[4] = page[0];
        ...
        case 2:
            page[0] = msx_mmu_alloc_page() | IO_MEM_ROM;
            page[1] = msx_mmu_alloc_page() | IO_MEM_ROM;
            page[2] = page[0];
            page[3] = page[1];
            page[4] = page[0];
            page[5] = page[1];
        ...
        case 3 ... 4:
            ...
            page[2] = page[0];
            page[3] = page[1];
            page[4] = msx_mmu_alloc_page() | IO_MEM_ROM;
            page[5] = msx_mmu_alloc_page() | IO_MEM_ROM;
            page[6] = page[4];
            page[7] = page[5];
            break;
        case 5 ... 7:
            page[0] = msx_mmu_alloc_page() | IO_MEM_ROM;
            page[1] = msx_mmu_alloc_page() | IO_MEM_ROM;
            page[2] = msx_mmu_alloc_page() | IO_MEM_ROM;
            page[3] = msx_mmu_alloc_page() | IO_MEM_ROM;
            page[4] = msx_mmu_alloc_page() | IO_MEM_ROM;
            page[5] = msx_mmu_alloc_page() | IO_MEM_ROM;
            page[6] = msx_mmu_alloc_page() | IO_MEM_ROM;
            page[7] = msx_mmu_alloc_page() | IO_MEM_ROM;
            break;
    }
    int i;
...
static void msx_mmu_reset(void *opaque)
{
    MMUState *mmu = (MMUState *)opaque;
    int page;
    for (page = 0; page < NUMPAGES; page++) {
        msx_mmu_map(mmu, page, 0);
    }
}

static void *msx_mmu_init(int ramslot)
{
