                      ...
                      const char *cpu_model)
{
    ...
    for(i = 0; i < nb_nics; i++) {
        ...
        dev = qdev_add_child(machine_dev, (BusState *)s390_bus, "virtio-net-s390", "virtio-net-s390");
    ...
    for(i = 0; i < MAX_BLK_DEVS; i++) {
        ...
        dev = qdev_add_child(machine_dev, (BusState *)s390_bus, "virtio-blk-s390", "virtio-blk-s390");
