...
static uint32_t scoop_readb(void *opaque, hw_addr_t addr)
{
...
static void scoop_writeb(void *opaque, hw_addr_t addr, uint32_t value)
{
    ScoopInfo *s = (ScoopInfo *) opaque;
    value &= 0xffff;
...
void sl_bootparam_write(hw_addr_t ptr)
{
