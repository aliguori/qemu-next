...
xilinx_intc_create(target_phys_addr_t base, qemu_irq irq, int kind_of_intr)
{
    ...
    dev = qdev_create(NULL, "xilinx,intc", "::xilinx,intc");
...
xilinx_timer_create(target_phys_addr_t base, qemu_irq irq, int nr, int freq)
{
    ...
    dev = qdev_create(NULL, "xilinx,timer", "::xilinx,timer");
                      ...
                      int txpingpong, int rxpingpong)
{
    ...
    dev = qdev_create(NULL, "xilinx,ethlite", "::xilinx,ethlite");
                          ...
                          int txmem, int rxmem)
{
    ...
    dev = qdev_create(NULL, "xilinx,axienet", "::xilinx,axienet");
    qdev_set_nic_properties(dev, nd);
                             ...
                             qemu_irq irq2, int freqhz)
{
    ...
    dev = qdev_create(NULL, "xilinx,axidma", "::xilinx,axidma");
