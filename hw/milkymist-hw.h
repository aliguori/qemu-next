        ...
        qemu_irq rx_irq, qemu_irq tx_irq)
{
    ...
    dev = qdev_create(NULL, "milkymist-uart", "::milkymist-uart");
...
static inline DeviceState *milkymist_hpdmc_create(target_phys_addr_t base)
{
    ...
    dev = qdev_create(NULL, "milkymist-hpdmc", "::milkymist-hpdmc");
    qdev_init_nofail(dev);
    sysbus_mmio_map(sysbus_from_qdev(dev), 0, base);
...
static inline DeviceState *milkymist_memcard_create(target_phys_addr_t base)
{
    ...
    dev = qdev_create(NULL, "milkymist-memcard", "::milkymist-memcard");
    qdev_init_nofail(dev);
    sysbus_mmio_map(sysbus_from_qdev(dev), 0, base);
        ...
        uint32_t fb_offset, uint32_t fb_mask)
{
    ...
    dev = qdev_create(NULL, "milkymist-vgafb", "::milkymist-vgafb");
        ...
        uint32_t gpio_strappings)
{
    ...
    dev = qdev_create(NULL, "milkymist-sysctl", "::milkymist-sysctl");
        ...
        qemu_irq irq)
{
    ...
    dev = qdev_create(NULL, "milkymist-pfpu", "::milkymist-pfpu");
    qdev_init_nofail(dev);
    sysbus_mmio_map(sysbus_from_qdev(dev), 0, base);
        ...
        qemu_irq irq)
{
    ...
    dev = qdev_create(NULL, "milkymist-tmu2", "::milkymist-tmu2");
    qdev_init_nofail(dev);
    sysbus_mmio_map(sysbus_from_qdev(dev), 0, base);
    sysbus_connect_irq(sysbus_from_qdev(dev), 0, irq);
        ...
        qemu_irq dmaw_irq)
{
    ...
    dev = qdev_create(NULL, "milkymist-ac97", "::milkymist-ac97");
    qdev_init_nofail(dev);
    sysbus_mmio_map(sysbus_from_qdev(dev), 0, base);
        ...
        qemu_irq rx_irq, qemu_irq tx_irq)
{
    ...
    dev = qdev_create(NULL, "milkymist-minimac", "::milkymist-minimac");
        ...
        target_phys_addr_t buffers_base, qemu_irq rx_irq, qemu_irq tx_irq)
{
    ...
    dev = qdev_create(NULL, "milkymist-minimac2", "::milkymist-minimac2");
        ...
        uint32_t dmem_base, uint32_t dmem_size)
{
    ...
    dev = qdev_create(NULL, "milkymist-softusb", "::milkymist-softusb");
