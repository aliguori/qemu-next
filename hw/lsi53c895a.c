...
static void lsi_mmio_writeb(void *opaque, hw_addr_t addr, uint32_t val)
{
    LSIState *s = opaque;
...
static void lsi_mmio_writew(void *opaque, hw_addr_t addr, uint32_t val)
{
    LSIState *s = opaque;
...
static void lsi_mmio_writel(void *opaque, hw_addr_t addr, uint32_t val)
{
    LSIState *s = opaque;
...
static uint32_t lsi_mmio_readb(void *opaque, hw_addr_t addr)
{
    LSIState *s = opaque;
...
static uint32_t lsi_mmio_readw(void *opaque, hw_addr_t addr)
{
    LSIState *s = opaque;
    uint32_t val;
...
static uint32_t lsi_mmio_readl(void *opaque, hw_addr_t addr)
{
    LSIState *s = opaque;
    uint32_t val;
    addr &= 0xff;
...
static void lsi_ram_writeb(void *opaque, hw_addr_t addr, uint32_t val)
{
    LSIState *s = opaque;
    uint32_t newval;
    int shift;
...
static void lsi_ram_writew(void *opaque, hw_addr_t addr, uint32_t val)
{
    LSIState *s = opaque;
    uint32_t newval;
...
static void lsi_ram_writel(void *opaque, hw_addr_t addr, uint32_t val)
{
    LSIState *s = opaque;
...
static uint32_t lsi_ram_readb(void *opaque, hw_addr_t addr)
{
    LSIState *s = opaque;
    uint32_t val;
...
static uint32_t lsi_ram_readw(void *opaque, hw_addr_t addr)
{
    LSIState *s = opaque;
    uint32_t val;
...
static uint32_t lsi_ram_readl(void *opaque, hw_addr_t addr)
{
    LSIState *s = opaque;
