...
static uint32_t i6300esb_mem_readb(void *vp, hw_addr_t addr)
{
...
static uint32_t i6300esb_mem_readw(void *vp, hw_addr_t addr)
{
    uint32_t data = 0;
    I6300State *d = (I6300State *) vp;
...
static uint32_t i6300esb_mem_readl(void *vp, hw_addr_t addr)
{
    i6300esb_debug("addr = %x\n", (int) addr);
...
static void i6300esb_mem_writeb(void *vp, hw_addr_t addr, uint32_t val)
{
    I6300State *d = (I6300State *) vp;
...
static void i6300esb_mem_writew(void *vp, hw_addr_t addr, uint32_t val)
{
    I6300State *d = (I6300State *) vp;
...
static void i6300esb_mem_writel(void *vp, hw_addr_t addr, uint32_t val)
{
    I6300State *d = (I6300State *) vp;
