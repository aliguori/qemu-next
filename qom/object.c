...
static void object_property_get_bool(Object *obj, Visitor *v, void *opaque,
                                     const char *name, Error **errp)
{
...
static void object_property_set_bool(Object *obj, Visitor *v, void *opaque,
                                     const char *name, Error **errp)
{
    BoolProperty *prop = opaque;
    Error *local_err = NULL;
...
static void object_property_release_bool(Object *obj, const char *name,
                                         void *opaque)
{
    BoolProperty *prop = opaque;
    g_free(prop);
                              ...
                              Error **errp)
{
    ...
    object_property_add(obj, name, "bool",
                        get ? object_property_get_bool : NULL,
                        set ? object_property_set_bool : NULL,
                        object_property_release_bool,
                        prop, errp);
}
